...
## 2. Creative Content & Media License (Creative Commons BY-NC-ND 4.0)

All creative assets, including but not limited to:
* Audio files (e.g., `.mp3`, `.wav` in `/public/sounds`)
* Audio files (e.g., `.mp4`, `.mov`, `.mp5` in `/public/videos`)
* Visual elements and images (e.g., `.webp`, `.jpg`, `.png`, `.svg` files in `/public/images`)
* Story texts, lyrics, and diary writings (e.g., journal content in `/src/data`)
