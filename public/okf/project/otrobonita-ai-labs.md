---
type: Organization
title: Otrobonita AI Labs
description: The lab behind Mark Twain Reappears, directed by Jesper Karlsson.
resource: https://mark.otrobonita.com/
tags: [organization, lab, ai]
timestamp: 2026-06-17T00:00:00Z
---

# Otrobonita AI Labs

The organization behind the project, directed by [Jesper Karlsson](/people/jesper-karlsson.md). It runs the corpus pipeline, the vector database, the on-site chat, the book, and the album, and publishes related Swedish-language writing on AI and organizations.

## Notable detail

**Fable 5** — a short-lived AI model that helped set the project's structure before being shut down only days after it started. It is part of the project's lore as the entity that "lived a few days."
...
## Related
- [Mark Twain Reappears site](/site/index.md) · [Corpus](/corpus/rag-corpus.md)
